...
sub new {
    ...
    my $metadata = $segment->fetch_metadata("zstddocs");
    if ($metadata) {
        ...
        # Open InStreams.
        my $dat_filename = $segment->get_name . "/zstddocs.dat";
        my $ix_filename  = $segment->get_name . "/zstddocs.ix";
...
LucyX::Index::ZstdDocReader - Compressed doc storage.
