...
package LucyX::Index::ZstdDocWriter;
...
sub _lazy_init {
    ...
    my $ix_file  = $self->get_segment->get_name . "/zstddocs.ix";
    my $dat_file = $self->get_segment->get_name . "/zstddocs.dat";
...
sub add_segment {
    ...
    confess("Not a ZstdDocReader")
        unless ( blessed($doc_reader)
        and $doc_reader->isa("LucyX::Index::ZstdDocReader") );
...
LucyX::Index::ZstdDocWriter - Compressed doc storage.
